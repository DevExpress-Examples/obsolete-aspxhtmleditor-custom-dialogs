...
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v10.2, Version=10.2.10.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dxe" %>
<%@ Register Assembly="DevExpress.Web.ASPxHtmlEditor.v10.2, Version=10.2.10.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxHtmlEditor" TagPrefix="dxhe" %>
<%@ Register Assembly="DevExpress.Web.v10.2, Version=10.2.10.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxPanel" TagPrefix="dxp" %>
<%@ Register Assembly="DevExpress.Web.v10.2, Version=10.2.10.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxPopupControl" TagPrefix="dx" %>
<%@ Register assembly="DevExpress.Web.v10.2, Version=10.2.10.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web.ASPxHiddenField" tagprefix="dxhf" %>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <dxe:ASPxTextBox ID="txbInsertImageUrl" ClientInstanceName="_dxeTbxInsertImageUrl" runat="server" Width="274px" AutoCompleteType="Disabled">
                                                                                ...
                                                                                <ValidationSettings ErrorDisplayMode="Text" ErrorTextPosition="Bottom" SetFocusOnError="True" ValidateOnLeave="False" ValidationGroup="_dxeTbxInsertImageUrlGroup" Display="Dynamic">
                                                                        ...
                                                                        <td style="padding-left: 8px" runat="server" id="SelectImageCell">
                                                                            <dxe:ASPxButton ID="btnBrowse" runat="server" AutoPostBack="false">
                                                                                <ClientSideEvents Click="function(s,e){aspxHEOnBrowseButtonClick();}" />
                                                                            </dxe:ASPxButton>
                                                                            <dx:ASPxPopupControl ID="BrowsePopup" runat="server" CloseAction="CloseButton" PopupAction="None"
                                                                                ...
                                                                                PopupVerticalAlign="Middle" AllowDragging="True" Modal="true" EnableAnimation="false">
                                                                                ...
                                                                                <ModalBackgroundStyle Opacity="1"></ModalBackgroundStyle>
                                                                                <ContentCollection>
                                                                                    <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
                                                                                        <ucip:SelectImageForm ID="SelectImageForm" runat="server" />
